...
rating = []
game = input('Для того, чтобы добавить игрока напишите '
             '- "+", чтобы закончить напишите - "-" ')
while game != '-':
    rating_player = int(input('Input rating player: '))
    rating.append(rating_player)
    rating.sort(reverse=True)
    print(rating)
    game = input('Хотите продолжить? (+/-): ')
print('Список рейтинга готов!')
